...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=12cm]{fig/sr300}
...
\section{深度图质量测试实验}
RGB-D相机相对于彩色图我们更关心其深度图的质量，因此设计实验测试了所采用的SR300相机深度图的质量以及改进的由两个SR300相机所组成的对偶RGB-D相机深度图的质量。所设计的实验通过考察以下三个指标来评价相机深度图的质量：
\begin{itemize}
\item 深度信息的精度
\item 深度信息的噪声
\item 深度信息的有效率
